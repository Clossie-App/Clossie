      ...
      <div className="p-4 space-y-4">
        ...
        <div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 divide-y divide-gray-100 dark:divide-gray-700">
            ...
            <button onClick={() => showToast('Privacy policy coming soon','info')} className="w-full flex items-center justify-between px-4 py-3.5"><div className="flex items-center gap-3"><span className="text-lg">&#x1F512;</span><span className="text-sm font-medium text-gray-700 dark:text-gray-200">Privacy Policy</span></div><Chevron /></button>
            <button onClick={() => showToast('Terms of service coming soon','info')} className="w-full flex items-center justify-between px-4 py-3.5"><div className="flex items-center gap-3"><span className="text-lg">&#x1F4C4;</span><span className="text-sm font-medium text-gray-700 dark:text-gray-200">Terms of Service</span></div><Chevron /></button>
