      ...
      <div className="p-4 space-y-4">
        ...
        <div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 divide-y divide-gray-100 dark:divide-gray-700">
            ...
            <Link href="/packing" className="flex items-center justify-between px-4 py-3.5"><div className="flex items-center gap-3"><span className="text-lg">&#x1F9F3;</span><span className="text-sm font-medium text-gray-700 dark:text-gray-200">Packing Lists</span></div><Chevron /></Link>
